...
JackV changes :
added 
    fixed values for calculator app
...
//    property string buttonHoverColor    : "blue"
    property string buttonHoverColor    : buttonActiveColor
//    property string buttonSelectedColor : "yellow"
    property string buttonSelectedColor : "lightgrey"
//    property string buttonDisabledColor : "lightgrey"
    property string buttonDisabledColor : buttonActiveColor
    property string textColor           : "black"
//    property string textDisabledColor   : "grey"
    property string textDisabledColor   : textColor
